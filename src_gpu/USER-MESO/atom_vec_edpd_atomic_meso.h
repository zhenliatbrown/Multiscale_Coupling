...
AtomStyle(edpd/atomic/meso,AtomVecEDPDAtomic)

#else

#ifndef LMP_MESO_ATOM_VEC_EDPD_ATOMIC
#define LMP_MESO_ATOM_VEC_EDPD_ATOMIC
...
class AtomVecEDPDAtomic: public AtomVecDPDAtomic
{
public:
    AtomVecEDPDAtomic(LAMMPS *lmp);
    ~AtomVecEDPDAtomic() {}
