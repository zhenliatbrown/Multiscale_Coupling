...
void ModifiedVerlet::init()
{
    ...
    if( modify->nfix == 0 && comm->me == 0 )
        error->warning( FLERR, "No fixes defined, atoms will not move" );
...
//__global__ void area_check(
//      int*  __restrict nangle,
//      int4* __restrict angles,
//      r64*  __restrict angle_a0,          //data file, equilibrium
//      const int padding,
...
//          int i3 = angle.z;
//          int type = angle.w;
//          //printf("i, (i1, i2, i3), equil area = %d (%d %d %d) %g \n",i,i1,i2,i3,angle_a0[i+p*padding_a0]);
//      }
//  }
//}
//
//
//__global__ void print_force (
...
//{
//  for (int i=0; i<nlocal; i++) {
//      //printf("i, (fx, fy, fz) = %d (%g %g %g) \n",i, force_x[i],force_y[i],force_z[i]);
//  }
//}
//
//
//__global__ void print_coord_local (
...
//{
//  for (int i=0; i<nlocal; i++) {
//      printf("i, (coordx, coordy, coordz) = %d (%g %g %g) \n",i, coord_x[i],coord_y[i],coord_z[i]);
//  }
//}
//
//
//__global__ void print_coord_ghost (
//      r64* __restrict coord_x,
//      r64* __restrict coord_y,
//      r64* __restrict coord_z,
//      const int nlocal, const int nghost)
//{
...
//                  meso_atom->dev_angle_mapped.pitch(),            meso_atom->dev_angle_a0.pitch(),
//                  atom->nlocal,
//                  atom->nghost);
//          meso_device->sync_device();
//          printf("%d\n",__LINE__);
//          print_coord_local<<<1,1>>> (
//                  meso_atom->dev_coord(0), meso_atom->dev_coord(1), meso_atom->dev_coord(2),
//                  atom->nlocal
//                  );
//          meso_device->sync_device();
//          print_coord_ghost<<<1,1>>> (
//                  meso_atom->dev_coord(0), meso_atom->dev_coord(1), meso_atom->dev_coord(2),
