...
AtomStyle(edpd/angle/meso,AtomVecEDPDAngle)

#else

#ifndef LMP_MESO_ATOM_VEC_EDPD_ANGLE
#define LMP_MESO_ATOM_VEC_EDPD_ANGLE
...
class AtomVecEDPDAngle: public AtomVecDPDAngle
{
public:
    AtomVecEDPDAngle(LAMMPS *lmp);
    ~AtomVecEDPDAngle() {}
